    ...
    <section className="container description__container">
      <div className="movieDex">
        ...
        <p>
          ...
          d’avoir une interface utilisateur et sa fonction principale sera, à
          partir d’une API, d’interagir avec le state globale de l’application,
          ici on utilisera une API regroupant des films et sa fonction
          principale sera d’annoter les films que l’utilisateur aura vu.
        </p>
        <p>
        ...
        <p>
          ...
          cross-platforms. J’ai donc imaginé la maquette d’une interface
          utilisateur et, à l’aide de nombreuses librairies disponibles avec
          React Native, l’ai réalisé en mettant en place une navigation entre
          les différents « screens », en interagissant avec mon API ainsi qu’une
          API provenant d’une base de données communautaire afin de créer la
          fonctionnalité principale qui gérerait le state global de
          l’application.
        </p>
      </div>
